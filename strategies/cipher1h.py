...
class cipher1h(IStrategy):
    ...
    #schaff val
    #schaff_fast_val= IntParameter(15,30, default = 23, space = 'buy')
    #schaff_slow_val= IntParameter(40,65, default = 50, space = 'buy')
    period = 10
    #buyval
